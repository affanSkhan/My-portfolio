...
export default function SkillCard({ skill, index = 0 }: { skill: Skill; index?: number }) {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-base sm:text-lg font-bold mb-1 text-zinc-800 dark:text-white">{skill.name}</h3>
      <p className="text-xs text-zinc-600 dark:text-zinc-300 mb-2">{skill.category}</p>
